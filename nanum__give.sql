...
MEMBER_TEL, MEMBER_ADDRESS, ENROLL_DATE, MEMBER_DEL_FL,
AUTHORITY, MEMBER_IMG
) VALUES (
    SEQ_MEMBER_NO.nextval, 'admin01', '$2a$10$VgjLXaLpWl98i3lRdYHUMuKCXWnfyHr6zL86Mtfz4JfMDGHyeGvNW', '관리자', 'admin@admin.com',
    '01012345678', NULL, SYSDATE, 'N',
    0, NULL
);
...
AUTHORITY, MEMBER_IMG
    ...
    SEQ_MEMBER_NO.nextval, 'hello', '$2a$10$VgjLXaLpWl98i3lRdYHUMuKCXWnfyHr6zL86Mtfz4JfMDGHyeGvNW', '헬로', 'hello@world.com',
    '01012345678', NULL, SYSDATE, 'N',
    1, NULL
);

SELECT * FROM "MEMBER" m ;
DELETE FROM "MEMBER" WHERE MEMBER_NO = 0;
COMMIT;
